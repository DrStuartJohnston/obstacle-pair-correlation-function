...
first_Correction = -(pw_Pair_Distance-hole_Pair_part1);
second_Correction = -(hole_Pair_part1-hole_Pair_Distances);

% Plot contributions to counts of pair distances, that is, inaccessible-accesible pairs, inaccessible-inaccesible pairs, shifted pairs
figure(5)
bar([pw_Pair_Distance,first_Correction,second_Correction],'stacked')
xlim([1 80])
hold on
plot(pw_Pair_Distance+first_Correction,'r','linewidth',2)
plot(hole_Pair_Distances,'g','linewidth',2)
