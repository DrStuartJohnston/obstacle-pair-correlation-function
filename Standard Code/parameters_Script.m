%% Script for defining parameters
% Defines the parameters needed to generate pair correlation functions.
...
Parameters.length_X = 50;                                                                                                                   %Size of domain in the x dimension
Parameters.length_Y = 50;                                                                                                                   %Size of domain in the y dimension
Parameters.num_Hole_Rows = 5;                                                                                                               %Number of rows of holes/obstacles
Parameters.num_Hole_Columns = 5;                                                                                                            %Number of columns of holes/obstacles
...
hole_Start_X = [6:9:Parameters.length_X];                                                                                                                          %Location of columns with holes/obstacles
hole_Start_Y = [6:9:Parameters.length_Y];                                                                                                                           %Location of rows with holes/obstacles       
hole_Length_X = 4*ones(size(hole_Start_X));                                                                                                          %Size of obstacle clusters in x (same length as hole_Start_X variable)    
hole_Length_Y = 4*ones(size(hole_Start_Y));                                                                                                          %Size of obstacle clusters in y (same length as hole_Start_Y variable)        
